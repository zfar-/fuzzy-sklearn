...
class fuzzy_sklearn (object):
    ...
    def logistic_regression (self,data) :
        ...
        return  self.dict_population(accuracy= clf.score(X_test,y_test) ,
    ...
    def decision_tree_classifier(self,data):
       ...
       #return_dict = {}
        ...
        return self.dict_population(accuracy=clf.score(self.X_test,),
